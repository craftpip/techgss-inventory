<nav class="navbar navbar-default navbar-fixed-top cp-nav" role="navigation" style="margin-bottom: 0">
                        ...
                        <div>
                            <div class="btn-group btn-block ">
                                <button onclick="history.back();
                                        return false" class="btn btn-primary"><i class="fa fa-arrow-left"></i></button>
                                <button onclick="func.renderCurrent();
                                        return false" class="btn btn-primary"><i class="fa fa-refresh"></i></button>
                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-cog fa-fw"></i> <span class="badge badge-default">YOU</span>
