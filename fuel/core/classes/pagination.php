...
class Pagination
{
	...
	protected $template = array(
		'wrapper'                 => "<div class=\"pagination\"><ul> \n\t{pagination}\n</ul></div>\n",
		'first'                   => "<li class='disabled'>\n\t{link}\n</span></li>\n",
		'first-link'              => "<li>\t\t<a href=\"{uri}\">{page}</a></li>\n",
		'previous'                => "<li><span >\n\t{link}\n</span></li>\n",
		'previous-link'           => "<li>\t\t<a href=\"{uri}\">{page}</a></li>\n",
		'previous-inactive'       => "<li class='active'><span >\n\t{link}\n</span></li>\n",
		'previous-inactive-link'  => "<li>\t\t<a href=\"{uri}\">{page}</a></li>\n",
		'regular'                 => "<li><span>\n\t{link}\n</span></li>\n",
		'regular-link'            => "<li>\t\t<a href=\"{uri}\">{page}</a></li>\n",
		'active'                  => "<li><span >\n\t{link}\n</span></li>\n",
		'active-link'             => "<li>\t\t<a href=\"{uri}\">{page}</a></li>\n",
		'next'                    => "<li><span >\n\t{link}\n</span></li>\n",
		'next-link'               => "<li>\t\t<a href=\"{uri}\">{page}</a></li>\n",
		'next-inactive'           => "<li class='active'><span >\n\t{link}\n</span></li>\n",
		'next-inactive-link'      => "<li class='active'>\t\t<a href=\"{uri}\">{page}</a></li>\n",
		'last'                    => "<li><span class=\"next\">\n\t{link}\n</span></li>\n",
		'last-link'               => "<li>\t\t<a href=\"{uri}\">{page}</a></li>\n",
	);
